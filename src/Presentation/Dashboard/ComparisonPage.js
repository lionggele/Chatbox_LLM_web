...
//       const response1 = await fetchResponseFromModel(selectedModel1, input, "container1");
//       const response2 = await fetchResponseFromModel(selectedModel2, input, "container2");
...
//                   <div
//                     key={displayName}
//                     onClick={() => handleModelSelectC(displayName, setSelectedModel1, setDropdownOpen1 ,"container1")}
